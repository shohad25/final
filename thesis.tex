...
In the following section we describe the physical foundations of MRI and methods for accelerating data acquisition.


\section{MRI basics}\label{intro:MRI_BASICS}
\subsection{Physics}\label{intro:basics:MRI_PHYSICS}
...
research.
\subsection{MRI Acquisition}\label{intro:basics:MRI_ACQ}
\subsection{K-space}\label{intro:basics:K_SPACE}
\subsection{Artifacts and Aliasing}\label{intro:basics:ARTIFACST_AND_ALIASING}
