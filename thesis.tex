...
%	\item[1]{Tzachi Hershkovich, et al. Probabilistic model for 3D interactive segmentation. Computer Vision and Image Understanding (CVIU), Special Issue on Probabilistic Models for Biomedical Image Analysis, 2016.}
	...
	\item[2]{Ohad Shitrit and Tammy Riklin Raviv. Accelerated Magnetic Resonance Imaging by Adversarial Neural Network. In Deep Learning in Medical Image Analysis and Multimodal Learning for Clinical Decision Support (pp. 30-38). Springer, Cham.}
	
\end{itemize}

% ------------- Acknowledgments ------------- $
\chapter{Acknowledgments}
In this chapter I will write Acknowledgments.
